...
Many options currently exists for displaying descriptive statistics. I recommend the function `mytable` from the `moonBook` package for construcing tables of descriptive statistics where results don't need to be stratified. 
