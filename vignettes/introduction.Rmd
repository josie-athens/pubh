...
We can use `pander` to display nice tables with labels.
...
In the previous table of coefficients confidence intervals and p-values for race had not been adjusted for multiple comparisons. We use functions from the `multcomp` package to make the corrections.
